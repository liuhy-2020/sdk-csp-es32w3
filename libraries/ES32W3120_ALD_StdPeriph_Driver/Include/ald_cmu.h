...
/**
  * @brief CMU LSCLK state structure definition
  */
typedef enum
{
    CMU_LSCLK_ULRC  = 0x1U, /**< ULRC */
    CMU_LSCLK_LRC_4 = 0x2U, /**< LRC_4 */
    CMU_LSCLK_LOSC  = 0x3U, /**< LOSC */
} cmu_lsclk_t;
...
typedef enum
{
    ...
    CMU_PCLK_1 = 0x1U,  /**< APB1 bus */
    CMU_PCLK_2 = 0x2U,  /**< APB2 bus */
    CMU_PCLK_3 = 0x3U,  /**< APB2 bus */
} cmu_bus_t;
...
typedef enum
{
    CMU_QSPI_CLOCK_SEL_SYS = 0x0U,      /**< Select SYSCLK */
    CMU_QSPI_CLOCK_SEL_PLL1H = 0x1U,    /**< Select PLL1CLKH */
...
/**
  ...
  * @{
  */
#define IS_CMU_LSCLK(x)     (((x) == CMU_LSCLK_ULRC) || \
                             ((x) == CMU_LSCLK_LRC_4) || \
                             ((x) == CMU_LSCLK_LOSC))
...
#define IS_CMU_QSPI_CLOCK_SEL(x)    (((x) == CMU_QSPI_CLOCK_SEL_SYS) || \
                                     ((x) == CMU_QSPI_CLOCK_SEL_PLL1H))
