...
typedef enum
{
    ...
    DMA_MSEL_TRNG    = 0x3U,    /**< TRNG */
    DMA_MSEL_ECC     = 0x5U,    /**< ECC */
...
typedef enum
{
    ...
    DMA_MSIGSEL_TRNG           = 0x0U,  /**< TRNG mode */
    DMA_MSIGSEL_ECC            = 0x0U,  /**< ECC mode */
    DMA_MSIGSEL_ADC            = 0x0U,  /**< ADC mode */
    DMA_MSIGSEL_CRC            = 0x0U,  /**< CRC mode */
    ...
    DMA_MSIGSEL_HASH           = 0x0U,  /**< HASH Write */
} dma_msigsel_t;
...
/**
  ...
  * @{
  */
#define IS_DMA_MSEL_TYPE(x) ((x) <= DMA_MSEL_HASH)
