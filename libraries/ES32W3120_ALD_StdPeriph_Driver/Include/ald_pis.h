...
typedef enum
{
    ...
    PIS_ADC0_NORMAL         = 0x60U,    /**< Adc0 normal, pclk2 pulse,support async */
    PIS_ADC0_INSERT         = 0x61U,    /**< Adc0 insert, pclk2 pulse,support async */
    ...
    PIS_LP16T_SYN_UPDATA    = 0x170U,   /**< Lp16t syn updata, pulse,support async */
    PIS_LP16T_ASY_UPDATA    = 0x171U,   /**< Lp16t asy updata, pulse,support async */
...
typedef enum
{
    PIS_CH15_DMA_CH15         = 0x00FFU, /* DMA CH15 */
    PIS_CH14_DMA_CH14         = 0x00FEU, /* DMA CH14 */
    PIS_CH13_DMA_CH13         = 0x00FDU, /* DMA CH13 */
    PIS_CH12_DMA_CH12         = 0x00FCU, /* DMA CH12 */
    PIS_CH11_DMA_CH11         = 0x00FBU, /* DMA CH11 */
    PIS_CH10_DMA_CH10         = 0x00FAU, /* DMA CH10 */
    PIS_CH9_DMA_CH9           = 0x00F9U, /* DMA CH9 */
    PIS_CH8_DMA_CH8           = 0x00F8U, /* DMA CH8 */
    PIS_CH7_DMA_CH7           = 0x00F7U, /* DMA CH7 */
    PIS_CH6_DMA_CH6           = 0x00F6U, /* DMA CH6 */
    PIS_CH5_DMA_CH5           = 0x00F5U, /* DMA CH5 */
    PIS_CH4_DMA_CH4           = 0x00F4U, /* DMA CH4 */
    PIS_CH3_DMA_CH3           = 0x00F3U, /* DMA CH3 */
    PIS_CH2_DMA_CH2           = 0x00F2U, /* DMA CH2 */
    PIS_CH1_DMA_CH1           = 0x00F1U, /* DMA CH1 */
    PIS_CH0_DMA_CH0           = 0x00F0U, /* DMA CH0 */
    PIS_CH7_ADC_ICHTRG        = 0x00F7U, /* ADC ICHTRG */
    PIS_CH6_ADC_NCHTRG        = 0x00F6U, /* ADC NCHTRG */
    PIS_CH15_TIM0_ITR3        = 0x00FFU, /* TIM0 ITR3 */
    PIS_CH14_TIM0_ITR2        = 0x00FEU, /* TIM0 ITR2 */
    PIS_CH13_TIM0_ITR1        = 0x00FDU, /* TIM0 ITR1 */
    PIS_CH12_TIM0_ITR0        = 0x00FCU, /* TIM0 ITR0 */
    PIS_CH15_TIM1_ITR3        = 0x00FFU, /* TIM1 ITR3 */
    PIS_CH14_TIM1_ITR2        = 0x00FEU, /* TIM1 ITR2 */
    PIS_CH13_TIM1_ITR1        = 0x00FDU, /* TIM1 ITR1 */
    PIS_CH12_TIM1_ITR0        = 0x00FCU, /* TIM1 ITR0 */
    PIS_CH15_TIM2_ITR3        = 0x00FFU, /* TIM2 ITR3 */
    PIS_CH14_TIM2_ITR2        = 0x00FEU, /* TIM2 ITR2 */
    PIS_CH13_TIM2_ITR1        = 0x00FDU, /* TIM2 ITR1 */
    PIS_CH12_TIM2_ITR0        = 0x00FCU, /* TIM2 ITR0 */
    PIS_CH15_TIM3_ITR3        = 0x00FFU, /* TIM3 ITR3 */
    PIS_CH14_TIM3_ITR2        = 0x00FEU, /* TIM3 ITR2 */
    PIS_CH13_TIM3_ITR1        = 0x00FDU, /* TIM3 ITR1 */
    PIS_CH12_TIM3_ITR0        = 0x00FCU, /* TIM3 ITR0 */
    ...
    PIS_CH7_LP16T_EXT_TRIG7   = 0x00F7U, /* LP16T EXT_TRIG7 */
    PIS_CH6_9_TIMER3_CMPIN0_3 = 0x1E06,  /**< Tim3 CMPIN0-3*/
    PIS_CH6_9_TIMER2_CMPIN0_3 = 0x1606,  /**< Tim2 CMPIN0-3*/
    PIS_CH6_9_TIMER1_CMPIN0_3 = 0x0E06,  /**< Tim1 CMPIN0-3*/
    PIS_CH6_9_TIMER0_CMPIN0_3 = 0x0606,  /**< Tim0 CMPIN0-3*/
    ...
    PIS_CH6_LP16T_EXT_TRIG6   = 0x00F6U, /* LP16T EXT_TRIG6 */
    PIS_CH5_SPI0_RX           = 0x0C15U, /**< SPI0 RX */
    PIS_CH5_LP16T_EXT_TRIG5   = 0x00F5U, /* LP16T EXT_TRIG5 */
    PIS_CH4_TIMER3_CH4IN      = 0x1B04U, /**< Tim3 input chan4 */
    PIS_CH4_TIMER2_CH4IN      = 0x1304U, /**< Tim2 input chan4 */
    PIS_CH4_TIMER1_CH4IN      = 0x0B04U, /**< Tim1 input chan4 */
    PIS_CH4_TIMER0_CH4IN      = 0x0304U, /**< Tim0 input chan4 */
    PIS_CH4_LP16T_EXT_TRIG4   = 0x00F4U, /* LP16T EXT_TRIG4 */
    PIS_CH3_TIMER3_CH3IN      = 0x1A03U, /**< Tim3 input chan3 */
    PIS_CH3_TIMER2_CH3IN      = 0x1203U, /**< Tim2 input chan3 */
    PIS_CH3_TIMER1_CH3IN      = 0x0A03U, /**< Tim1 input chan3 */
    PIS_CH3_TIMER0_CH3IN      = 0x0203U, /**< Tim0 input chan3 */
    PIS_CH3_LP16T_EXT_TRIG3   = 0x00F3U, /* LP16T EXT_TRIG3 */
    PIS_CH2_TIMER3_CH2IN      = 0x1902U, /**< Tim3 input chan2 */
    PIS_CH2_TIMER2_CH2IN      = 0x1102U, /**< Tim2 input chan2 */
    PIS_CH2_TIMER1_CH2IN      = 0x0902U, /**< Tim1 input chan2 */
    PIS_CH2_TIMER0_CH2IN      = 0x0102U, /**< Tim0 input chan2 */
    PIS_CH2_LP16T_EXT_TRIG2   = 0x00F2U, /* LP16T EXT_TRIG2 */
    PIS_CH1_TIMER3_CH1IN      = 0x1801U, /**< Tim3 input chan1 */
    PIS_CH1_TIMER2_CH1IN      = 0x1001U, /**< Tim2 input chan1 */
    PIS_CH1_TIMER1_CH1IN      = 0x0801U, /**< Tim1 input chan1 */
    PIS_CH1_LP16T_EXT_TRIG1   = 0x00F1U, /* LP16T EXT_TRIG1 */
    PIS_CH1_TIMER0_CH1IN      = 0x0001U, /**< Tim0 input chan1 */
    PIS_CH0_TIMER0_BRKIN      = 0x0400U, /**< Tim0 break in */
    PIS_CH0_TIMER2_BRKIN      = 0x1400U, /**< Tim2 break in */
    PIS_CH0_TIMER3_BRKIN      = 0x1C00U, /**< Tim3 break in */
    PIS_CH0_LP16T_EXT_TRIG0   = 0x00F0U, /* LP16T EXT_TRIG0 */
...
#define IS_PIS_SRC(x)       (((x) == PIS_NON)       || \
                             ...
                             ((x) == PIS_RTC_CLOCK)         || \
                             ((x) == PIS_RTC_ALARM)         || \
                             ((x) == PIS_LP16T_SYN_UPDATA)  || \
                             ((x) == PIS_LP16T_ASY_UPDATA)  || \
                             ((x) == PIS_DMA))
#define IS_PIS_TRIG(x)      (((x) == PIS_CH15_DMA_CH15)   || \
                             ((x) == PIS_CH14_DMA_CH14)           || \
                             ((x) == PIS_CH13_DMA_CH13)           || \
                             ((x) == PIS_CH12_DMA_CH12)           || \
                             ((x) == PIS_CH11_DMA_CH11)           || \
                             ...
                             ((x) == PIS_CH1_DMA_CH1)             || \
                             ((x) == PIS_CH0_DMA_CH0)             || \
                             ((x) == PIS_CH7_ADC_ICHTRG)          || \
                             ((x) == PIS_CH6_ADC_NCHTRG)          || \
                             ((x) == PIS_CH15_TIM0_ITR3)          || \
                             ((x) == PIS_CH14_TIM0_ITR2)          || \
                             ((x) == PIS_CH13_TIM0_ITR1)          || \
                             ((x) == PIS_CH12_TIM0_ITR0)          || \
                             ((x) == PIS_CH15_TIM1_ITR3)          || \
                             ((x) == PIS_CH14_TIM1_ITR2)          || \
                             ((x) == PIS_CH13_TIM1_ITR1)          || \
                             ((x) == PIS_CH12_TIM1_ITR0)          || \
                             ((x) == PIS_CH15_TIM2_ITR3)          || \
                             ((x) == PIS_CH14_TIM2_ITR2)          || \
                             ((x) == PIS_CH13_TIM2_ITR1)          || \
                             ((x) == PIS_CH12_TIM2_ITR0)          || \
                             ((x) == PIS_CH15_TIM3_ITR3)          || \
                             ((x) == PIS_CH14_TIM3_ITR2)          || \
                             ((x) == PIS_CH13_TIM3_ITR1)          || \
                             ((x) == PIS_CH12_TIM3_ITR0)          || \
                             ((x) == PIS_CH11_UART2_RXD)          || \
                             ((x) == PIS_CH10_UART1_RXD)          || \
                             ((x) == PIS_CH9_UART0_RXD)           || \
                             ((x) == PIS_CH8_SPI1_CLK)            || \
                             ((x) == PIS_CH7_SPI1_RX)             || \
                             ((x) == PIS_CH7_LP16T_EXT_TRIG7)     || \
                             ((x) == PIS_CH6_9_TIMER3_CMPIN0_3)   || \
                             ((x) == PIS_CH6_9_TIMER2_CMPIN0_3)   || \
                             ((x) == PIS_CH6_9_TIMER1_CMPIN0_3)   || \
                             ((x) == PIS_CH6_9_TIMER0_CMPIN0_3)   || \
                             ((x) == PIS_CH6_TIMER3_CH2IN)        || \
                             ((x) == PIS_CH6_TIMER2_CH2IN)        || \
                             ((x) == PIS_CH6_SPI0_CLK)            || \
                             ((x) == PIS_CH6_LP16T_EXT_TRIG6)     || \
                             ((x) == PIS_CH5_SPI0_RX)             || \
                             ((x) == PIS_CH5_LP16T_EXT_TRIG5)     || \
                             ((x) == PIS_CH4_TIMER3_CH4IN)        || \
                             ((x) == PIS_CH4_TIMER2_CH4IN)        || \
                             ((x) == PIS_CH4_TIMER1_CH4IN)        || \
                             ((x) == PIS_CH4_TIMER0_CH4IN)        || \
                             ((x) == PIS_CH4_LP16T_EXT_TRIG4)     || \
                             ((x) == PIS_CH3_TIMER3_CH3IN)        || \
                             ((x) == PIS_CH3_TIMER2_CH3IN)        || \
                             ((x) == PIS_CH3_TIMER1_CH3IN)        || \
                             ((x) == PIS_CH3_TIMER0_CH3IN)        || \
                             ((x) == PIS_CH3_LP16T_EXT_TRIG3)     || \
                             ((x) == PIS_CH2_TIMER3_CH2IN)        || \
                             ((x) == PIS_CH2_TIMER2_CH2IN)        || \
                             ((x) == PIS_CH2_TIMER1_CH2IN)        || \
                             ((x) == PIS_CH2_TIMER0_CH2IN)        || \
                             ((x) == PIS_CH2_LP16T_EXT_TRIG2)     || \
                             ((x) == PIS_CH1_TIMER3_CH1IN)        || \
                             ((x) == PIS_CH1_TIMER2_CH1IN)        || \
                             ((x) == PIS_CH1_TIMER1_CH1IN)        || \
                             ((x) == PIS_CH1_LP16T_EXT_TRIG1)     || \
                             ((x) == PIS_CH1_TIMER0_CH1IN)        || \
                             ((x) == PIS_CH0_TIMER0_BRKIN)        || \
                             ((x) == PIS_CH0_TIMER2_BRKIN)        || \
                             ((x) == PIS_CH0_TIMER3_BRKIN)        || \
                             ((x) == PIS_CH0_LP16T_EXT_TRIG0)     || \
                             ((x) == PIS_TRIG_RESERVE))
