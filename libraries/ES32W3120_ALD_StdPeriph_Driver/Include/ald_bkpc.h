...
/**
  ...
  */
typedef enum {
	BKPC_PREH_CLK_ULRC    = 0x0U,	/**< ULRC */
	BKPC_PREH_CLK_LOSM    = 0x1U,	/**< LOSM */
} bkpc_preh_clk_t;
...
/**
  ...
  */
typedef enum {
	PMU_STANDBY_PORT_SEL_PA2  = 0x0U,	/**< Wakeup by PA2 */
	PMU_STANDBY_PORT_SEL_PA3  = 0x1U,	/**< Wakeup by PA3 */
	PMU_STANDBY_PORT_SEL_PA4  = 0x2U,	/**< Wakeup by PA4 */
	PMU_STANDBY_PORT_SEL_PA5  = 0x3U,	/**< Wakeup by PA5 */
	PMU_STANDBY_PORT_SEL_PA6  = 0x4U,	/**< Wakeup by PA6 */
	PMU_STANDBY_PORT_SEL_PA7  = 0x5U,	/**< Wakeup by PA7 */
    PMU_STANDBY_PORT_SEL_PA8  = 0x6U,	/**< Wakeup by PA8 */
	PMU_STANDBY_PORT_SEL_PA9  = 0x7U,	/**< Wakeup by PA9 */
	PMU_STANDBY_PORT_SEL_RTC  = 0x9U,	/**< Wakeup by RTC */
    PMU_STANDBY_PORT_SEL_NONE = 0xAU,	/**< NONE */
} bkpc_wakeup_port_t;
...
/**
  ...
  * @{
  */
#define IS_BKPC_WAKEUP_PORT(x)	(((x) == PMU_STANDBY_PORT_SEL_PA2) || \
                                 ...
                                 ((x) == PMU_STANDBY_PORT_SEL_PA8) || \
                                 ((x) == PMU_STANDBY_PORT_SEL_PA9) || \
                                 ((x) == PMU_STANDBY_PORT_SEL_RTC) || \
