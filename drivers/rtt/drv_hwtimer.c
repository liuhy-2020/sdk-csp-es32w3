...
static struct es32w3_hwtimer_dev ad16c4t0_hwtimer;
...
{                                                
    if (ald_timer_get_it_status(ad16c4t0_hwtimer.hwtimer_periph, TIMER_IT_UPDATE) &&
            ald_timer_get_flag_status(ad16c4t0_hwtimer.hwtimer_periph, TIMER_FLAG_UPDATE))
    {
...
static struct es32w3_hwtimer_dev ad16c4t1_hwtimer;
...
{                 
    if (ald_timer_get_it_status(ad16c4t1_hwtimer.hwtimer_periph, TIMER_IT_UPDATE) &&
            ald_timer_get_flag_status(ad16c4t1_hwtimer.hwtimer_periph, TIMER_FLAG_UPDATE))
    {
...
static struct es32w3_hwtimer_dev gp16c4t0_hwtimer;
...
void GP16C4T0_IRQHandler(void)
{    
    if (ald_timer_get_it_status(gp16c4t0_hwtimer.hwtimer_periph, TIMER_IT_UPDATE) &&
            ald_timer_get_flag_status(gp16c4t0_hwtimer.hwtimer_periph, TIMER_FLAG_UPDATE))
    {
...
static struct es32w3_hwtimer_dev gp16c4t1_hwtimer;
...
{      
    if (ald_timer_get_it_status(gp16c4t1_hwtimer.hwtimer_periph, TIMER_IT_UPDATE) &&
            ald_timer_get_flag_status(gp16c4t1_hwtimer.hwtimer_periph, TIMER_FLAG_UPDATE))
    {
...
static struct es32w3_hwtimer_dev bs16t0_hwtimer;
...
void BS16T0_IRQHandler(void)
{    
    if (ald_timer_get_it_status(bs16t0_hwtimer.hwtimer_periph, TIMER_IT_UPDATE) &&
            ald_timer_get_flag_status(bs16t0_hwtimer.hwtimer_periph, TIMER_FLAG_UPDATE))
    {
...
static struct es32w3_hwtimer_dev bs16t1_hwtimer;
...
{
    if (ald_timer_get_it_status(bs16t1_hwtimer.hwtimer_periph, TIMER_IT_UPDATE) &&
            ald_timer_get_flag_status(bs16t1_hwtimer.hwtimer_periph, TIMER_FLAG_UPDATE))
    {
...
static void es32w3_hwtimer_init(rt_hwtimer_t *timer, rt_uint32_t state)
{
    struct es32w3_hwtimer_dev *hwtimer = (struct es32w3_hwtimer_dev *)timer->parent.user_data;
...
static rt_err_t es32w3_hwtimer_start(rt_hwtimer_t *timer,
                                     rt_uint32_t cnt,
...
static void es32w3_hwtimer_stop(rt_hwtimer_t *timer)
{
    struct es32w3_hwtimer_dev *hwtimer = (struct es32w3_hwtimer_dev *)timer->parent.user_data;
...
static rt_uint32_t es32w3_hwtimer_count_get(rt_hwtimer_t *timer)
{
    struct es32w3_hwtimer_dev *hwtimer = (struct es32w3_hwtimer_dev *)timer->parent.user_data;
...
static rt_err_t es32w3_hwtimer_control(rt_hwtimer_t *timer,
                                       rt_uint32_t cmd,
                                       void *args)
{
    rt_err_t ret = RT_EOK;
...
static struct rt_hwtimer_ops es32w3_hwtimer_ops =
{
    es32w3_hwtimer_init,
    es32w3_hwtimer_start,
    es32w3_hwtimer_stop,
    es32w3_hwtimer_count_get,
    es32w3_hwtimer_control
};
...
int rt_hw_hwtimer_init(void)
{
    ...
    ad16c4t0_hwtimer.parent.ops = &es32w3_hwtimer_ops;
    ...
    ad16c4t1_hwtimer.parent.ops = &es32w3_hwtimer_ops;
    ...
    gp16c4t0_hwtimer.parent.ops = &es32w3_hwtimer_ops;
    ...
    gp16c4t1_hwtimer.parent.ops = &es32w3_hwtimer_ops;
    ...
    bs16t0_hwtimer.parent.ops = &es32w3_hwtimer_ops;
    ...
    bs16t1_hwtimer.parent.ops = &es32w3_hwtimer_ops;
