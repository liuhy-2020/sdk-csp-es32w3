...
static rt_err_t es32w3_pwm_control(struct rt_device_pwm *device, int cmd, void *arg)
{
    rt_err_t ret = RT_EOK;
    uint64_t _arr,bus_speed,tmp;
    uint32_t _ccep_ch_en = 0U;
    ...
    case PWM_CMD_SET:
        ...
        tmp = bus_speed * (cfg->period)/1000000000/0xFFFF;
...
const static struct rt_pwm_ops es32w3_pwm_ops =
{
    es32w3_pwm_control
};
...
int rt_hw_pwm_init(void)
{
    ...
    ret = rt_device_pwm_register(&ad16c4t1_pwm_dev, ES_DEVICE_NAME_AD16C4T1_PWM, &es32w3_pwm_ops,
