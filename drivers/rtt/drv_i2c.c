...
static void _i2c_init(void)
{
    ...
    _h_i2c0.perh = I2C0;
    _h_i2c0.init.clk_speed    = ES_I2C0_CLK_SPEED;//100000;
    _h_i2c0.init.own_addr1    = ES_I2C0_OWN_ADDR1;//0xA0;
    _h_i2c0.init.addr_mode    = ES_I2C0_ADDR_MODE;//I2C_ADDR_7BIT;
    _h_i2c0.init.general_call = ES_I2C0_GENERAL_CALL;//I2C_GENERALCALL_DISABLE;
    _h_i2c0.init.no_stretch   = ES_I2C0_STRETCH;//I2C_NOSTRETCH_ENABLE;
    ...
    /* Initialize i2c function */
    _h_i2c1.perh = I2C1;
    _h_i2c1.init.clk_speed    = ES_I2C1_CLK_SPEED;//100000;
    _h_i2c1.init.own_addr1    = ES_I2C1_OWN_ADDR1;//0xA0;
    _h_i2c1.init.addr_mode    = ES_I2C1_ADDR_MODE;//I2C_ADDR_7BIT;
    _h_i2c1.init.general_call = ES_I2C1_GENERAL_CALL;//I2C_GENERALCALL_DISABLE;
    _h_i2c1.init.no_stretch   = ES_I2C1_STRETCH;//I2C_NOSTRETCH_ENABLE;
...
static rt_size_t es32w3_master_xfer(struct rt_i2c_bus_device *bus,
...
const struct rt_i2c_bus_device_ops es32w3_i2c_ops =
{
    es32w3_master_xfer,
    RT_NULL,
    RT_NULL,
...
int rt_hw_i2c_init(void)
{
    ...
    _i2c_device0.ops = &es32w3_i2c_ops;
    ...
    _i2c_device1.ops = &es32w3_i2c_ops;
