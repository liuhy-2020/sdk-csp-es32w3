...
static rt_err_t es32w3_rtc_control(rt_device_t dev, int cmd, void *args)
{
...
const static struct rt_device_ops es32w3_rtc_ops =
{
    RT_NULL,
    RT_NULL,
    RT_NULL,
...
int rt_hw_rtc_init(void)
{
    ...
    rtc_dev.control = es32w3_rtc_control;
#endif
